...
export async function setupWebsocketServer() {
    ...
    .then(server => {
        ...
        ops.addListener('sendVoid', () => { console.log("Received 'sendVoid' event")})
        ops.addListener('sendString', s => {console.log("Received 'sendString' event: " + s)})
        ops.addListener('sendArray', arr => {console.log("Received 'sendArray' event: " + JSON.stringify(arr))})
        ops.addListener('sendObject', obj => {console.log("Received 'sendObject' event: " + JSON.stringify(obj))})
        otherOps.addListener('sendNumber', num => {console.log("Received 'sendNumber' event: " + num)})
